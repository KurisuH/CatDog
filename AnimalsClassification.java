...
//        MultiLayerNetwork network = new AlexNet(height, width, channels, numLabels, seed, iterations).init();
        ...
        if (save) {
            ...
            String basePath = "C:/Users/Chris/Documents/GitHub/dl4j-examples/dl4j-examples/src/main/resources/";
...
/*
        //-----------------------------
        System.out.println("Show some tests");

        dataIter.reset();

        System.out.println("Class labels: " + allClassLabels.toString());
        ...
        while(dataIter.hasNext()) {
            ...
            testDataSet = dataIter.next();
            allClassLabels = recordReader.getLabels();
            labelIndex = testDataSet.getLabels().argMax(1).getInt(0);
            predictedClasses = network.predict(testDataSet.getFeatures());
            expectedResult = allClassLabels.get(labelIndex);
            modelPrediction = allClassLabels.get(predictedClasses[0]);
            System.out.println("\n Expected  " + expectedResult + " Prediction" + modelPrediction);
...
*/
    ...
    public MultiLayerNetwork customModel() {
        ...
        String filepath = "C:/Users/Chris/Documents/GitHub/dl4j-examples/dl4j-examples/src/main/resources/model.bin";
